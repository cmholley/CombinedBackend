...
public interface ClassService {
	 ...
	 * 
	 * @param clas
	 *            The new class to be created.
	 * @param loc
	 *            The location that offers the class.
	 * @return The new class ID.
	 * @throws AppException
	 *             if class has to be generated does not contain a name.
	 */
	 ...
	 * 
	 * @param classes
	 *            The list of classes to be created
	 * @param location
	 *            The location that offers the classes.
	 * @throws AppException
	 *             if classes to be created do not contain at least a name.
	 */
	 ...
	 *            Define in what order the classes should be returned
	 * @param numberDaysToLookBack
	 *            The number of days to look back.
	 * @return A list of all classes.
	 * @throws AppException
	 *             orderByInsertionDate must be ASC or DESC
	 */
	 ...
	 * 
	 * @param location
	 *            The location that classes should be listed for.
	 ...
	 * @throws AppException
	 *             if class with specified id can't be found.
	 */
	 ...
	 * 
	 * @param orderByInsertionDate
	 *            The order in which the classes should be returned.
	 * @param numberDaysToLookBack
	 *            The number of days to go back.
	 * @return List of classes that user is a member.
	 * @throws AppException
	 *             if orderByInserationDate is not "ASC" or "DESC"
	 */
